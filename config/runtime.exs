...
#
#     PHX_SERVER=true bin/gongu start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :gongu, GonguWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  ssl_enabled = !String.contains?(database_url, "sslmode=disable")
  ...
  config :gongu, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
