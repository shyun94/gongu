...
export type ListGroupsFields =
  UnifiedFieldSelection<GonguGroupsGroupResourceSchema>[];

type InferListGroupsResult<Fields extends ListGroupsFields> =
  | {
...
export type ListGroupsResult<Fields extends ListGroupsFields> =
  | { success: true; data: InferListGroupsResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function listGroups<Fields extends ListGroupsFields>(config: {
  fields: Fields;
...
export async function validateListGroups(config: {
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
    input: RequestInfo | URL,
...
type InferCreateGroupResult<Fields extends CreateGroupFields> = InferResult<
  GonguGroupsGroupResourceSchema,
  Fields
>;

export type CreateGroupResult<Fields extends CreateGroupFields> =
  | { success: true; data: InferCreateGroupResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function createGroup<Fields extends CreateGroupFields>(config: {
...
export async function validateCreateGroup(config: {
  input: CreateGroupInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export type GetGroupFields =
  UnifiedFieldSelection<GonguGroupsGroupResourceSchema>[];

type InferGetGroupResult<Fields extends GetGroupFields> =
  | {
      results: Array<InferResult<GonguGroupsGroupResourceSchema, Fields>>;
      hasMore: boolean;
      limit: number;
...
export type GetGroupResult<Fields extends GetGroupFields> =
  | { success: true; data: InferGetGroupResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function getGroup<Fields extends GetGroupFields>(config: {
  fields: Fields;
  filter?: GonguGroupsGroupFilterInput;
  sort?: string;
  page?:
...
export async function validateGetGroup(config: {
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
    input: RequestInfo | URL,
...
type InferUpdateGroupResult<Fields extends UpdateGroupFields> = InferResult<
  GonguGroupsGroupResourceSchema,
  Fields
>;

export type UpdateGroupResult<Fields extends UpdateGroupFields> =
  | { success: true; data: InferUpdateGroupResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function updateGroup<Fields extends UpdateGroupFields>(config: {
  primaryKey: UUID;
...
export async function validateUpdateGroup(config: {
  primaryKey: string;
  input: UpdateGroupInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
...
export async function validateDeleteGroup(config: {
  primaryKey: string;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export type ListMembershipsFields =
  UnifiedFieldSelection<GonguGroupsGroupMembershipResourceSchema>[];

type InferListMembershipsResult<Fields extends ListMembershipsFields> =
  | {
      results: Array<
...
export type ListMembershipsResult<Fields extends ListMembershipsFields> =
  | { success: true; data: InferListMembershipsResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function validateListMemberships(config: {
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
    input: RequestInfo | URL,
...
export type JoinGroupFields =
  UnifiedFieldSelection<GonguGroupsGroupMembershipResourceSchema>[];

type InferJoinGroupResult<Fields extends JoinGroupFields> = InferResult<
  GonguGroupsGroupMembershipResourceSchema,
  Fields
>;

export type JoinGroupResult<Fields extends JoinGroupFields> =
  | { success: true; data: InferJoinGroupResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function joinGroup<Fields extends JoinGroupFields>(config: {
...
export async function validateJoinGroup(config: {
  input: JoinGroupInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export type InviteToGroupFields =
  UnifiedFieldSelection<GonguGroupsGroupMembershipResourceSchema>[];

type InferInviteToGroupResult<Fields extends InviteToGroupFields> = InferResult<
  GonguGroupsGroupMembershipResourceSchema,
  Fields
>;

export type InviteToGroupResult<Fields extends InviteToGroupFields> =
  | { success: true; data: InferInviteToGroupResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function validateInviteToGroup(config: {
  input: InviteToGroupInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export type AcceptInvitationFields =
  UnifiedFieldSelection<GonguGroupsGroupMembershipResourceSchema>[];

type InferAcceptInvitationResult<Fields extends AcceptInvitationFields> =
  InferResult<GonguGroupsGroupMembershipResourceSchema, Fields>;

export type AcceptInvitationResult<Fields extends AcceptInvitationFields> =
  | { success: true; data: InferAcceptInvitationResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function validateAcceptInvitation(config: {
  primaryKey: string;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export type UpdateMemberRoleFields =
  UnifiedFieldSelection<GonguGroupsGroupMembershipResourceSchema>[];

type InferUpdateMemberRoleResult<Fields extends UpdateMemberRoleFields> =
  InferResult<GonguGroupsGroupMembershipResourceSchema, Fields>;

export type UpdateMemberRoleResult<Fields extends UpdateMemberRoleFields> =
  | { success: true; data: InferUpdateMemberRoleResult<Fields> }
  | {
      success: false;
      errors: Array<{
        type: string;
...
export async function validateUpdateMemberRole(config: {
  primaryKey: string;
  input: UpdateMemberRoleInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
...
export async function leaveGroup(config: {
  primaryKey: UUID;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
...
export async function validateLeaveGroup(config: {
  primaryKey: string;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (
